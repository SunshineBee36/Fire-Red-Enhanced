...
const u8 gText_Physical[] = _("Físico");
const u8 gText_Special[]  = _("Especial");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_TRAINER1MON1AND2COMEBACK - BATTLESTRINGS_TABLE_START]      = sText_Trainer1RecallBoth, //coma a borrar deespues del debug
    [STRINGID_PHYSICAL - BATTLESTRINGS_TABLE_START]                                                  = gText_Physical,
    [STRINGID_SPECIAL - BATTLESTRINGS_TABLE_START]                                                   = gText_Special,
    [STRINGID_STATUS - BATTLESTRINGS_TABLE_START]                                                    = gText_Status
